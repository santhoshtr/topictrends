// Study harness: measure canonical (cross-wiki union) category membership
// against per-wiki depth traversal. Not part of the ETL pipeline — a manual
// probe for evaluating union-based membership before/after topology changes.
//
// Modes:
