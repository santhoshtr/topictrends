...
pub struct PageContext {
    ...
    pub is_content_gap_compare: bool,
    pub is_content_gap_discover: bool,
...
impl PageContext {
    pub fn home() -> Self {
        Self {
            ...
            is_content_gap_compare: false,
            is_content_gap_discover: false,
    ...
    pub fn gap_discovery() -> Self {
        Self {
            page_title: "Topic Trends - Gap Discovery".to_string(),
            is_pageviews_active: false,
            is_pageedits_active: false,
            is_google_search_active: false,
            is_search_active: false,
            ...
            is_top_articles_google_search: false,
            is_top_categories_google_search: false,
            form_id: Some("gap-discovery-form".to_string()),
        }
    }
}
...
pub fn render_template(
    ...
    context.insert(
        "is_content_gap_compare",
        &page_context.is_content_gap_compare,
    );
    context.insert(
        "is_content_gap_discover",
        &page_context.is_content_gap_discover,
    );
