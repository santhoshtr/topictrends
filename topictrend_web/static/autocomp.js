// Autocomp: https://github.com/knadh/autocomp.js/
// MIT License
// Copyright (c) 2023 Kailash Nadh. https://nadh.in
...
export function autocomp(el, options = {}) {
  ...
  function handleKeydown(e) {
    ...
    switch (e.keyCode) {
      case 38:
        return navigate(-1, e); // Up arrow.
      case 40:
        return navigate(1, e); // Down arrow
      case 9: // Tab
      case 13: // Enter
        e.preventDefault();
        select(cur);
